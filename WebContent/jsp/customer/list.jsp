										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="baseDistLevel.dict_item_name"/></TD>
													<TD><s:property value="baseDistSource.dict_item_name"/></TD>
													<TD><s:property value="baseDistIndustry.dict_item_name"/></TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												[<A href="javascript:to_page(<s:property value='totalPage'/>)">首页</A>]
												</s:if>
												到
