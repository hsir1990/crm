...
<BODY>
<s:form theme="simple" id="form1" name="form1" action="saleVisit_save" method="post" namespace="/">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间：</td>
								<td>
									<s:textfield readonly="true" name="visit_time" cssStyle="WIDTH:180px " cssClass="textbox" id="visit_time"/>
								</td>
								<td>拜访的地点 ：</td>
								<td>
								<s:textfield name="visit_addr" maxlength="50" cssStyle="WIDTH:180px " cssClass="textbox" id="sChannel2"/>
							...
							<TR>
								...
								<td>拜访的详情 ：</td>
								<td>
								<s:textfield name="visit_detail" maxlength="50" cssStyle="WIDTH:180px " cssClass="textbox" id="sChannel2"/>

								</td>
								<td>下次拜访时间 ：</td>
								<td>
								<s:textfield readonly="true" name="visit_nexttime" maxlength="50" cssStyle="WIDTH:180px " cssClass="textbox" id="visit_nexttime"/>
